...
{{- if .NIST }}
	"github.com/khulnasoft/recryptor/sign/mldsa/{{.Pkg}}/internal"
{{- else }}
	"github.com/khulnasoft/recryptor/sign/dilithium/{{.Pkg}}/internal"
{{- end }}
	common "github.com/khulnasoft/recryptor/sign/internal/dilithium"
)
