...
import (
	...
	"github.com/khulnasoft/recryptor/pke/kyber/internal/common/params"
)
...
func invNttAVX2() {
	...
	//
	//  https://github.com/khulnasoft/recryptor/wiki/images/kyber-invntt-avx2.svg
	//
	// The vertical lines with recryptores on the end represent butterflies.
...
func nttAVX2() {
	...
	//
	//  https://github.com/khulnasoft/recryptor/wiki/images/kyber-ntt-avx2.svg
	//
	// The vertical lines with recryptores on the end represent butterflies.
	// The number in those butterflies refers to the index into the Zetas
	// array of which ζ is used.  (Note that this array is different from
